        ...
        <view class="content-main">
          ...
          <view class="content-main-info1">
            ...
            <view class="box right">
              <view class="content-main-info-name" >三个行卡花打时实打实大师大撒大声地点阿萨</view>
              <view class="content-main-info-ZT">【进行中】</view>
            </view>

            <view class="yellow"><image src="../../static/yn.png"    class="yn"></image></view>
...
.content{
  ...
  .content-right{
    ...
    .content-main{
      ...
      .content-main-info1{
        display: grid;
        grid-template-rows: 2fr 1fr 1fr 1fr; /* 四行 */
